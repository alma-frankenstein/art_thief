...
# # example:
# # python3 show_me.py --nargs "https://www.artsy.net/artwork/salvador-dali-madonne"\
# "https://www.artsy.net/artwork/vivian-maier-0117585-jeweler-through-window"
...
# print("Example: https://www.artsy.net/artwork/andy-warhol-jean-paul-gaultier-1\
# https://www.artsy.net/artwork/ndidi-emefiele-play-station-2-1")
# urls = input()
# urls = urls.split(" ")
